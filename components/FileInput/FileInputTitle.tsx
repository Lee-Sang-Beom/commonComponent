...
import style from "./FileInputTitle.module.scss";
    ...
    (
        ...
        return (
            <>
                 ...
                 */}
                <div className={`${style.title_box} ${size ? style[size] : style.md}`}>
                ...
                />
                {/* 파일목록을 출력하는 영역 */}
                <div className={`${style.files_box} ${size ? style[size] : style.md} ${border ? style[border] : ""}`}>
